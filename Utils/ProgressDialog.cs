...
namespace Utils
{
    public class ProgressDialog
    {
        ...
        public enum Animations
        {
            ...
            [AnimationInfo("shell32.dll", 150)]
            FlashlightSearch,
            [AnimationInfo("shell32.dll", 160)]
            Move,
            [AnimationInfo("shell32.dll", 161)]
            Copy,
            [AnimationInfo("shell32.dll", 162)]
            Recycle,
            [AnimationInfo("shell32.dll", 163)]
            EmptyRecycleBin,
            [AnimationInfo("shell32.dll", 164)]
            Delete,
            [AnimationInfo("shell32.dll", 165)]
            CheckList,
            [AnimationInfo("shell32.dll", 166)]
            InternetSearch,
            [AnimationInfo("shell32.dll", 167)]
            Move98,
            [AnimationInfo("shell32.dll", 168)]
            Copy98,
            [AnimationInfo("shell32.dll", 169)]
            Delete98,

            [AnimationInfo("wiadefui.dll", 1000)]
            DigitalCameraToPC,
            [AnimationInfo("wiadefui.dll", 1001)]
            ScannerToPC,
            [AnimationInfo("wiadefui.dll", 1002)]
            VideoCameraToPC,
            [AnimationInfo("wiadefui.dll", 1003)]
            VideoCameraWirelessToPC,
            [AnimationInfo("wiadefui.dll", 1004)]
            ScannerWirelessToPC,
            [AnimationInfo("wiadefui.dll", 1005)]
            DigitalCameraWirelessToPC,
            [AnimationInfo("wiadefui.dll", 1006)]
            DigitalCameraAndScannerToPC,

            [AnimationInfo("ieframe.dll", 544)]
            InternetToFolder,
            [AnimationInfo("wmploc.dll", 450)]
            InternetToFolder98,

            [AnimationInfo("ieakui.dll", 404)]
            Cogs,

            [AnimationInfo("syncui.dll", 133)]
            Swap,
            [AnimationInfo("syncui.dll", 134)]
            Merge
        }

        [AttributeUsage(AttributeTargets.All)]
        private class AnimationInfoAttribute : Attribute
        {
            public string Filename { get; set; }
            public ushort ResourceId { get; set; }
            public AnimationInfoAttribute(string filename, ushort resourceId)
            {
                Filename = filename;
        ...
        public string Line1
        {
            ...
            set
            {
                ...
                if (pd != null)
                {
                    pd.SetLine(1, this._line1, true, IntPtr.Zero);
                }
            }
        }
        ...
        public string Line2
        {
            ...
            set
            {
                ...
                if (pd != null)
                {
                    pd.SetLine(2, this._line2, true, IntPtr.Zero);
                }
            }
        }
        ...
        public string Line3
        {
            ...
            set
            {
                ...
                if (pd != null)
                {
                    pd.SetLine(3, this._line3, true, IntPtr.Zero);
                }
            }
        }
