    ...
    public class Log
    {
        ...
        public void LogException(Exception ex)
        {
            if (ex != null)
            {
                ...
                message.AppendLine("Unhandled Exception: " + ex.Message + Environment.NewLine);
                message.AppendLine(ex.ToString());
                message.AppendLine("--------" + Environment.NewLine + Environment.NewLine);
        ...
        private void Write(string level, string message)
        {
            ...
            if (LogMessageAdded != null)
                LogMessageAdded(output.ToString());
        }
        ...
        public event LogMessageHandler LogMessageAdded;
